...
<div id="myModal1" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <br>
    <div class="input-group">
      <i class="glyphicon glyphicon-eye-open x1" > Confirm Password</i>
      <br> 
      <br>
      <input id="cpassword1" type="password" class="form-control" name="cpassword1" placeholder="Confirm Password" style="width:540px;" value="">
    </div>
    <br>
